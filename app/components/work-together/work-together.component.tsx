...
import { sendEmail } from '@/app/utils/email.util';
...
export const WorkTogether = (props: Props) => {
  ...
  return (
    <div className='container w-[920px] mx-auto'>
      ...
      <div className='flex gap-8'>
        <div className='flex flex-col gap-8 font-light'>
          ...
          <div className='social flex flex-col gap-6 items-center justify-center mt-16'>
