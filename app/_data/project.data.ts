import { Project } from "../_db/schema";


export const projectCard: Project = {
  id: "1",
  featuredImageUrl: 'https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/IVI-Portfolio/dpe6bb7metmbs37rn1cx',
  ...
  createdAt: new Date(),
  markdown: `![Blog image](https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/github/lwd7kefogt2m60aexnyj)

North Island College needs to offer more activities for students to do in their free time. In this documentation we'll look at possible a data model that could power such an app.
...
![NIC Athletics Data Model](https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/github/ae2qyz7ygucdefdxa9ut)
...
![NIC Athletics User Model](https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/github/m9ccjsijjnbm7vrwdbyl)
...
![NIC Athletics Blog Model](https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/github/c5bfc9hbvpfyyna98tvj)
...
![NIC Athletics Blog Model](https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/github/qloygxhssnipry7qkit4)
...
export const MARKDOWN_MOCK =
  `![Blog image](https://res.cloudinary.com/boucekdev/image/upload/f_auto,q_auto/v1/github/lwd7kefogt2m60aexnyj)
